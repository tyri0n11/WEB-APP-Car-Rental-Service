...
let JwtAccessGuard = class JwtAccessGuard extends (0, passport_1.AuthGuard)('jwt') {
    ...
    handleRequest(err, user, info) {
        if (err || !user) {
            throw err || new common_1.UnauthorizedException('User not authenticated');
        }
        return user;
    }
};
...
//# sourceMappingURL=jwtAccess.guard.js.map