...
import './carDetail.css'; // Import the new CSS file
    ...
    <div className="container">
      <div>
        <div className="imageGallery">
          <img src={mainImage} alt={`${car.make} ${car.model}`} className="mainImage" />
        ...
        <div className="carInfo">
          ...
          <div className="section">
            <h2 className="sectionTitle">Additional Features</h2>
          ...
          <div className="section">
            <h2 className="sectionTitle">Security Deposit</h2>
      ...
      <div className="bookingCard">
        <div className="priceInfo">
          ...
          <span className="perDay">/ngày</span>
        </div>
